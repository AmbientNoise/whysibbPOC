...
//			direction:			"ltr",
			...
			buttons: 			"bold,italic,underline,strike,sup,sub,|,img,video,link,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,quote,hide,code,table,removeFormat",
			allButtons: {
				bold : {
					title: CURLANG.bold,
				...
				quote : {
					...
					transform : { 
                        ...
                        '<strong class="quoteheader">{AUTHOR}</strong> wrote: <blockquote>{SELTEXT}</blockquote':'[quote={AUTHOR}]{SELTEXT}[/quote]'
					}
				},
                hide : {
					title: CURLANG.hide,
					...
					//subInsert: true,
					transform : { 
						'<strong>Hidden text</strong>: <a href="javascript:void(0);" onclick="BBCode.spoiler(this);">Show</a> <blockquote class="hidden spoiler">{SELTEXT}</blockquote><br><br>':"[hide]{SELTEXT}[/hide]",
                        '<strong>{CTEXT}</strong>: <a href="javascript:void(0);" onclick="BBCode.spoiler(this);">Show</a> <blockquote class="hidden spoiler">{SELTEXT}</blockquote><br><br>':"[hide={CTEXT}]{SELTEXT}[/hide]"
				...
				fontsize: {
					...
					options: "fs_verysmall,fs_small,fs_normal,fs_big,fs_bigger,fs_verybig,fs_header"
				},
				fontfamily: {
					type: 'select',
                ...
                fs_bigger: {
					title: CURLANG.fs_bigger,
					buttonText: "fs5",
					excmd: 'fontSize',
					exvalue: "5",
					transform: {
						'<font size="5">{SELTEXT}</font>':'[size=175]{SELTEXT}[/size]'
					}
				},
				fs_verybig: {
                ...
                fs_header: {
					title: CURLANG.fs_header,
					buttonText: "fs7",
					excmd: 'fontSize',
					exvalue: "7",
					transform: {
						'<strong><font size="5">{SELTEXT}</font></strong>':'[header]{SELTEXT}[/header]'
					}
				},
